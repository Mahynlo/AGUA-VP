  ...
  return (
    <>
      <style>{`
        @media print {
          ...
          * { -webkit-print-color-adjust: exact !important; print-color-adjust: exact !important; }
          ...
          /* Evita que los bloques individuales se partan a la mitad */
      ...
      <div className="report-body" style={{
        ...
        {/* FOOTER FIJO ORIGINAL */}
        <div className="page-footer" style={{ borderTop: "1px solid #e5e7eb", fontSize: "9px", color: "#6b7280", display: "flex", justifyContent: "space-between" }}>
