            ...
            <div className="flex items-center justify-end flex space-x-4 " style={{
              ...
              <div className="flex items-center space-x-1 text-gray-200">
                <Tooltip content="Minimizar" color="default" delay={2000}>
                  ...
                  >
                    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" classname="icon icon-tabler icons-tabler-outline icon-tabler-minus"><path stroke="none" d="M0 0h24v24H0z" fill="none" /><path d="M5 12l14 0" /></svg>
                  </button>
                </Tooltip>
