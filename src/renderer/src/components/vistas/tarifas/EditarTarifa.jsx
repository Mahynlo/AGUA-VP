...
export default function EditarTarifa({ tarifa, onTarifaEditada }) {
  ...
  const inputClasses = "w-full bg-slate-100/70 dark:bg-zinc-900/80 border border-slate-200 dark:border-zinc-800 rounded-xl hover:border-slate-300 dark:hover:border-zinc-700 focus:ring-2 focus:ring-emerald-500/20 focus:outline-none focus:border-emerald-500 transition-all duration-200 shadow-none px-3 text-sm font-medium text-slate-800 dark:text-zinc-100";
  ...
  return (
    <>
      <button
        ...
        className="font-bold bg-slate-100 hover:bg-slate-200 dark:bg-zinc-800 dark:hover:bg-zinc-700 text-slate-700 dark:text-zinc-200 rounded-xl px-6 h-11 ml-2 flex items-center transition-all active:scale-95"
      >
