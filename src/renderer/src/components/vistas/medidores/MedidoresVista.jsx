      ...
      <div className="w-full h-full bg-white overflow-x-hidden p-4 rounded-lg shadow-md dark:bg-gray-800">
        <div className="grid grid-cols-5 grid-rows-5 gap-2 h-full">
          ...
          <div className="col-span-2 row-span-5 p-6 bg-white border border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700 overflow-y-auto">
            <h5 className="mb-2 text-2xl font-bold tracking-tight text-gray-900 dark:text-white text-center">Medidores</h5>
            <RegistrarMedidor />

            <div class="grid grid-cols-3 grid-rows-1 gap-2 mt-2">
              <div class="block  p-4 bg-gray-100 border border-gray-400 rounded-lg shadow hover:bg-gray-100 dark:bg-gray-800 dark:border-gray-500">
                <h2>Total:</h2>
                <h3 className="text-3xl text-center">{medidores.length}</h3>
              </div>
              <div class="block  p-4 bg-gray-100 border border-gray-400 rounded-lg shadow hover:bg-gray-100 dark:bg-gray-800 dark:border-gray-500">
                <h2>Asignados:</h2>
                <h3 className="text-3xl text-center">{medidoresAsignados.length}</h3>
              </div>
              <div class="block  p-4 bg-gray-100 border border-gray-400 rounded-lg shadow hover:bg-gray-100 dark:bg-gray-800 dark:border-gray-500">
                <h3>Libres: </h3>
                <h3 className="text-3xl text-center">{medidoresNoAsignados.length}</h3>
              </div>
