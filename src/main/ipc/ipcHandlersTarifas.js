...
export default function IpcHandlersTarifas () {
    ...
    ipcMain.handle("register-tarifa", async (event, data) => {
        ...
        return await registerTarifas(tarifa, token_session);
    });
    ...
    ipcMain.handle("registrar-rangos-tarifa", async (event, data) => {
        try {
            ...
            return await registrarRangosTarifa(rangos, tarifaId, token_session);
        } catch (error) {
    ...
    ipcMain.handle("update-tarifa", async (event, data) => {
        try {
            ...
            return await updateTarifa(id, nuevosDatos, token_session);
        } catch (error) {
    ...
    ipcMain.handle("update-rangos-tarifa", async (event, data) => {
        try {
            ...
            return await updateRangosTarifa(id, rangos, token_session);
        } catch (error) {
